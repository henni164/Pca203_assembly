...
scoring_data <- read.csv("/Users/evahenningsen/Documents/Research/203_assembly/Heatmap_figure/203_pathotyping_for_heatmap.csv", header=TRUE, check.names=FALSE, stringsAsFactors=FALSE)
...
row_names <- scoring_data_numeric$"Differential"
...
scoring_plot <- Heatmap(scoring_matrix,
                        ...
                        width = unit(30, "mm"), #adjust the widthe depending on how many isolates you have
...
pdf("203_heatmap.pdf", width = 3, height = 8.2)
scoring_plot
dev.off()
